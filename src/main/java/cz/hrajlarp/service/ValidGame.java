...
public class ValidGame {
    ...
    public Game getGameEntity(){
        ...
        game.setSubstitutesText(replacementsText);
    ...
    public ValidGame(Game entity){
        ...
        setBothRole("" + entity.getBothRole());
        setMenRole("" + entity.getMenRole());
        setWomenRole("" + entity.getWomenRole());
        ...
        setReplacementsText(entity.getSubstitutesText());
    ...
    public void setTextareas(Game game) {
        ...
        setReplacementsText(game.getSubstitutesText());
    }
