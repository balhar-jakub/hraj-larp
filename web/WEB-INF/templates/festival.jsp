...
<div class="text">
    ...
    <p>Pilířem HRAJ LARP je festival komorních larpů, který v roce 2013 proběhne již potřetí. Každý týden bude v rámci
        festivalu uveden jeden komorní larp.</p>

    <p>Kromě už zkušených hráčů bychom rádi motivovali zejména nováčky, aby odhodili strach a přišli si larp zahrát. Na
    ...
    <p>Kdy a kde se hry konají, se dozvíte v <a href=../kalendar/>Kalendáři</a>, je-li na hru potřeba nějaký kostým a
        všechny další potřebné informace na detailu hry (kam se dostanete z Kalendáře).</p>

    <p>Na většině larpů uváděných v rámci festivalu HRAJ LARP je přítomen fotograf. Přihlášením na hru souhlasíte s tím,
        že <strong>fotografie s vámi mohou být použity k propagačním účelům</strong>. Pokud si z jakéhokoliv důvodu
        nepřejete být foceni, dejte nám o tom prosím předem vědět na náš mail hraj@larp.cz. Individuálně se domluvíme,
    ...
    <p>Účastnický poplatek plaťte před hrou převodem na transparentní účet <strong>2300302640/2010</strong> vedený u Fio
        banky. Do popisu platby uvádějte prosím své jméno a název hry, na kterou se hlásíte. Jako variabilní symbol
        zadejte datum konání hry ve formátu ddmmrrrr. Zda platba skutečně dorazila, si můžete sami ověřit na <a
            href="https://www.fio.cz/scgi-bin/hermes/dz-transparent.cgi?ID_ucet=2300302640">online výpisu z účtu</a>.
    </p>
