...
ALTER TABLE public.accountant OWNER TO hrajlarp;
...
--
-- Name: hraj_email_authentication_id_seq; Type: SEQUENCE; Schema: public; Owner: hrajlarp
--
...
ALTER TABLE public.hraj_email_authentication_id_seq OWNER TO hrajlarp;

--
-- Name: email_authentication; Type: TABLE; Schema: public; Owner: hrajlarp; Tablespace:
--
...
ALTER TABLE public.email_authentication OWNER TO hrajlarp;

--
-- Name: first_line; Type: TABLE; Schema: public; Owner: hrajlarp; Tablespace:
--
...
ALTER TABLE public.first_line OWNER TO hrajlarp;
...
ALTER TABLE public.places_finder OWNER TO hrajlarp;
...
ALTER TABLE public.scheduler OWNER TO hrajlarp;
...
--
-- Name: email_authentication_pkey; Type: CONSTRAINT; Schema: public; Owner: hrajlarp; Tablespace:
--

ALTER TABLE ONLY email_authentication
ADD CONSTRAINT email_authentication_pkey PRIMARY KEY (id);
...
--
-- Name: email_authentication_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: hrajlarp
--

ALTER TABLE ONLY email_authentication
ADD CONSTRAINT email_authentication_user_id_fkey FOREIGN KEY (user_id) REFERENCES hraj_user(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
--
-- Name: scheduler_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: hrajlarp
--
